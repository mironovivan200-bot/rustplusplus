...
module.exports = {
    ...
    async execute(rustplus, client) {
        ...
        if (client.activeRustplusInstances[guildId]) {
            ...
            client.rustplusReconnectTimers[guildId] = setTimeout(client.createRustplusInstance.bind(client), Config.general.reconnectIntervalMs, guildId, rustplus.server, rustplus.port, rustplus.playerId, rustplus.playerToken);
        }
    },
};
