...
module.exports = async (client, guild, steamId) => {
    ...
    if (steamId === hoster) {
        client.log(client.intlGet(null, 'warningCap'), client.intlGet(null, 'credentialsCannotStartLiteAlreadyHoster', {
            steamId: steamId
        }));
        return;
    }
                        ...
                        case 'entity':
                            {
                                switch (body.entityName) {
                                    ...
                                    default:
                                        {
                                            client.log('FCM LITE', `GuildID: ${guild.id}, SteamID: ${steamId}, ` +
