...
module.exports = {
    ...
    getData(client, guildId) {
        return new Builder.SlashCommandBuilder()
            ...
            .setRequired(true)
            .addChoices({ name: client.intlGet(guildId, 'storageMonitor'), value: 'storage_monitor' }, { name: client.intlGet(guildId, 'toolCupboard'), value: 'tool_cupboard' }, { name: client.intlGet(guildId, 'largeWoodBox'), value: 'large_wood_box' }, { name: client.intlGet(guildId, 'vendingMachine'), value: 'vending_machine' })));
    },
