...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (interaction.options.getSubcommand() === 'clean') {
            file = new Discord.AttachmentBuilder(Path.join(__dirname, '..', '..', `maps/${interaction.guildId}_map_clean.png`));
        }
        else {
            file = new Discord.AttachmentBuilder(Path.join(__dirname, '..', '..', `maps/${interaction.guildId}_map_full.png`));
        }
        ...
        rustplus.log(client.intlGet(interaction.guildId, 'infoCap'), client.intlGet(interaction.guildId, 'displayingMap', { mapName: fileName }));
    },
};
