            ...
            case 'join':
                {
                    ...
                    if (voiceState && voiceState.channel) {
                        ...
                        client.log(client.intlGet(null, 'infoCap'), client.intlGet(interaction.guildId, 'commandsVoiceJoin', { name: voiceChannel && voiceChannel.name ? voiceChannel.name : client.intlGet(interaction.guildId, 'unknown'),
