...
module.exports = {
    ...
    getData(client, guildId) {
        return new Builder.SlashCommandBuilder()
            ...
            .setRequired(false)
            .addChoices({ name: client.intlGet(guildId, 'recycler'), value: 'recycler' }, { name: client.intlGet(guildId, 'shredder'), value: 'shredder' }, { name: client.intlGet(guildId, 'safe-zone-recycler'), value: 'safe-zone-recycler' }));
    },
