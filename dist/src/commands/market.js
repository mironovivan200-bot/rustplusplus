...
module.exports = {
    ...
    getData(client, guildId) {
        return new Builder.SlashCommandBuilder()
            ...
            .setRequired(true)
            .addChoices({ name: client.intlGet(guildId, 'all'), value: 'all' }, { name: client.intlGet(guildId, 'buy'), value: 'buy' }, { name: client.intlGet(guildId, 'sell'), value: 'sell' }))
            .addStringOption(option => option
            .setName('name')
            ...
            case 'search':
                {
                    ...
                    rustplus.log(client.intlGet(interaction.guildId, 'infoCap'), client.intlGet(interaction.guildId, 'searchResult', { name: itemName }));
                }
                break;
            case 'subscribe':
                {
                    ...
                    if (instance.marketSubscriptionList[orderType].includes(itemId)) {
                        ...
                        await client.interactionEditReply(interaction, DiscordEmbeds.getActionInfoEmbed(0, str, instance.serverList[rustplus.serverId].title));
            ...
            case 'list':
                {
                    ...
                    rustplus.log(client.intlGet(interaction.guildId, 'infoCap'), client.intlGet(interaction.guildId, 'showingSubscriptionList'));
                }
                break;
            default:
                {
