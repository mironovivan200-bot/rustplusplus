...
module.exports = {
    ...
    getServerButtons: function (guildId, serverId, state = null) {
        ...
        if (Config.battlemetrics.token !== '' && server.battlemetricsId !== null) {
            return [
                new Discord.ActionRowBuilder().addComponents(connectionButton, linkButton, battlemetricsButton, editButton, deleteButton),
    ...
    getSmartSwitchButtons: function (guildId, serverId, entityId) {
        ...
        return new Discord.ActionRowBuilder().addComponents(module.exports.getButton({
    ...
    getSmartSwitchGroupButtons: function (guildId, serverId, groupId) {
        ...
        return [
            new Discord.ActionRowBuilder().addComponents(module.exports.getButton({
