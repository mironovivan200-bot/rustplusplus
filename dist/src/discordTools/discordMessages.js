...
module.exports = {
    sendMessage: async function (guildId, content, messageId, channelId, interaction = null) {
        ...
        if (message !== undefined) {
            ...
            if (!channel) {
                Client.client.log(Client.client.intlGet(null, 'errorCap'), Client.client.intlGet(null, 'couldNotGetChannelWithId', { id: channelId }), 'error');
                return;
            }
    ...
    sendServerMessage: async function (guildId, serverId, state = null, interaction = null) {
        ...
        const message = await module.exports.sendMessage(guildId, content, server.messageId, instance.channelId.servers, interaction);
        if (!interaction) {
    ...
    sendTrackerMessage: async function (guildId, trackerId, interaction = null) {
        ...
        const message = await module.exports.sendMessage(guildId, content, tracker.messageId, instance.channelId.trackers, interaction);
        if (!interaction) {
    ...
    sendSmartSwitchMessage: async function (guildId, serverId, entityId, interaction = null) {
        ...
        const message = await module.exports.sendMessage(guildId, content, entity.messageId, instance.channelId.switches, interaction);
        if (!interaction) {
    ...
    sendSmartAlarmMessage: async function (guildId, serverId, entityId, interaction = null) {
        ...
        const content = {
            ...
            files: [new Discord.AttachmentBuilder(Path.join(__dirname, '..', `resources/images/electrics/${entity.image}`))]
        };
        const message = await module.exports.sendMessage(guildId, content, entity.messageId, instance.channelId.alarms, interaction);
        if (!interaction) {
    ...
    sendStorageMonitorMessage: async function (guildId, serverId, entityId, interaction = null) {
        ...
        const message = await module.exports.sendMessage(guildId, content, entity.messageId, instance.channelId.storageMonitors, interaction);
        if (!interaction) {
    ...
    sendSmartSwitchGroupMessage: async function (guildId, serverId, groupId, interaction = null) {
        ...
        const content = {
            ...
            files: [new Discord.AttachmentBuilder(Path.join(__dirname, '..', `resources/images/electrics/${group.image}`))]
        };
        const message = await module.exports.sendMessage(guildId, content, group.messageId, instance.channelId.switchGroups, interaction);
        if (!interaction) {
    ...
    sendStorageMonitorRecycleMessage: async function (guildId, serverId, entityId, items) {
        ...
        const content = {
            ...
            files: [new Discord.AttachmentBuilder(Path.join(__dirname, '..', 'resources/images/electrics/recycler.png'))]
        };
    ...
    sendInformationMapMessage: async function (guildId) {
        ...
        const message = await module.exports.sendMessage(guildId, content, instance.informationMessageId.map, instance.channelId.information);
        if (message) {
    ...
    sendUpdateMapInformationMessage: async function (rustplus) {
        ...
        const content = {
            files: [new Discord.AttachmentBuilder(Path.join(__dirname, '..', '..', `maps/${rustplus.guildId}_map_full.png`))]
        };
        const message = await module.exports.sendMessage(rustplus.guildId, content, instance.informationMessageId.map, instance.channelId.information);
    ...
    sendUpdateServerInformationMessage: async function (rustplus) {
        ...
        const message = await module.exports.sendMessage(rustplus.guildId, content, instance.informationMessageId.server, instance.channelId.information);
    ...
    sendUpdateEventInformationMessage: async function (rustplus) {
        ...
        const message = await module.exports.sendMessage(rustplus.guildId, content, instance.informationMessageId.event, instance.channelId.information);
    ...
    sendUpdateTeamInformationMessage: async function (rustplus) {
        ...
        const message = await module.exports.sendMessage(rustplus.guildId, content, instance.informationMessageId.team, instance.channelId.information);
    ...
    sendUpdateBattlemetricsOnlinePlayersInformationMessage: async function (rustplus, battlemetricsId) {
        ...
        const message = await module.exports.sendMessage(rustplus.guildId, content, instance.informationMessageId.battlemetricsPlayers, instance.channelId.information);
