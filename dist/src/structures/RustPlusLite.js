...
async function rustPlusLiteConnectedEvent(rustplusLite) {
    ...
    if (!rustplusLite.isResponseValid(info)) {
        rustplusLite.log(Client.client.intlGet(null, 'errorCap'), Client.client.intlGet(null, 'somethingWrongWithConnection'), 'error');
...
async function rustPlusLiteDisconnectedEvent(rustplusLite) {
    rustplusLite.log(Client.client.intlGet(null, 'disconnectedCap'), Client.client.intlGet(null, 'disconnectedFromServer'));
    /* Was the disconnection unexpected? */
    if (rustplusLite.isActive && Client.client.activeRustplusInstances[rustplusLite.guildId]) {
        rustplusLite.log(Client.client.intlGet(null, 'reconnectingCap'), Client.client.intlGet(null, 'reconnectingToServer'));
        ...
        Client.client.rustplusLiteReconnectTimers[rustplusLite.guildId] = setTimeout(rustplusLite.rustplus.updateLeaderRustPlusLiteInstance.bind(rustplusLite.rustplus), Config.general.reconnectIntervalMs);
    }
}
