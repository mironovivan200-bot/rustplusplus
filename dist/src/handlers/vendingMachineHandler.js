        ...
        for (const vendingMachine of vendingMachines) {
            ...
            for (const order of sellOrders) {
                ...
                for (const orderType of ['all', 'buy', 'sell']) {
                    const found = rustplus.foundSubscriptionItems[orderType].find(e => e.vId === vId && e.itemId === itemId && e.currencyId === currencyId);
                    ...
                    const items = [];
                    if (subscriptionList[orderType].includes(itemId))
                        items.push(itemName);
                    if (subscriptionList[orderType].includes(currencyId))
